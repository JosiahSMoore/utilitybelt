...
// without a valid cookie — everything else, including /list and Server
// Function POSTs (which Next.js routes to the page they were called from,
// not a separate path), gets redirected to the login form.
